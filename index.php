					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="main-nav">
							<ul class="nav navbar-nav navbar-right">
								<li><a href="https://www.abebooks.com/" target="_blank">AbeBooks</a></li>
								<li><a href="https://www.groupon.com/" target="_blank">Groupon</a></li>
								<li><a href="https://www.jetpens.com/" target="_blank">JetPens</a></li>
								<li><a href="https://customcultsnowboards.com/index.php" target="_blank">CustomCult</a></li>
							</ul>
						</div><!-- /.navbar-collapse -->
					</div><!-- /.container-fluid -->
				</nav>
				...
				<div class="row">
					<div class="col-md-4">
						...
						<form>
							...
							<div class="form-group">
								<label for="emailEmail">Email Address</label>
								<input id="emailEmail" name="emailEmail" class="form-control" type="email" placeholder="Email Address">
							</div>
							<div class="form-group">
